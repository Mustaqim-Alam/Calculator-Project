...
console.log(index)
jokescontainer.innerHTML = myjokes[index].joke


document.getElementsByClassName('claas')[0].innerHTML = myjokes[index].joke
document.getElementsByClassName('claas')[0].innerHTML = myjokes[index].category